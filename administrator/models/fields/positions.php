...
class JFormFieldPositions extends JFormFieldList
{
    ...
    {
        $options = array();
        $table = '#__gavoting_positions';
        $label = Text::_('COM_GAVOTING_TITLE_POSITION'); // label in the list options ie "- Select $label - "
        $field = 'pos_name'; // field to display in the list options
