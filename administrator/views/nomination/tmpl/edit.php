...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'nomination.cancel') {
			Joomla.submitform(task, document.getElementById('nomination-form'));
		} else {
			if (task != 'nomination.cancel' && document.formvalidator.isValid(document.id('nomination-form'))) {
				Joomla.submitform(task, document.getElementById('nomination-form'));
			} else {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="nomination-form" class="form-validate form-horizontal">
	...
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				...
				<?php echo $this->form->renderField('nom_name'); ?>
				<?php echo $this->form->renderField('nom_date'); ?>
