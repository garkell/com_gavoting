 ...
 * @since  1.6
 */
class GavotingControllerPosition extends BaseController
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Position', 'GavotingModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_gavoting') || $user->authorise('core.edit.state', 'com_gavoting'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(Route::_('index.php?option=com_gavoting&view=positions', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_gavoting'))
		{
			...
			else
			{
                ...
                $app->redirect(Route::_('index.php?option=com_gavoting&view=positions', false));
			}
