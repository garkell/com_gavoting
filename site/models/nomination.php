 ...
 * @since  1.6
 */
class GavotingModelNomination extends ItemModel
{
    public $_item;
	...
	public function getItem($id = null)
	{
		...
		if (isset($this->_item->position_id)) {
			$this->_item->position_id_name = GavotingHelper::getPosition($this->_item->position_id)->position_name;
		}

		if (isset($this->_item->nom_id)) {
			$this->_item->nomby_name = Factory::getUser($this->_item->nom_id)->name;
		}
		if (isset($this->_item->sec_id)) {
			$this->_item->secby_name = Factory::getUser($this->_item->sec_id)->name;
		}
